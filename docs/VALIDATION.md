...
Il [corpus golden pubblico](../benchmark/public_golden/README.md) aggiunge cinque casi riproducibili con PDF redistribuibili: i test rapidi usano snapshot nativi, mentre la CI riesegue l'estrazione Docling. Entrambi costruiscono e validano EPUB, verificano le risorse e la riproducibilità byte per byte. La matrice pubblica distingue i controlli obbligatori dai difetti già osservati; questi ultimi non sono considerati risolti dal solo esito verde della CI.
